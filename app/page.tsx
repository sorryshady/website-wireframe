    ...
    >
      ...
      {!isLoading && (
        <>
          ...
          >
            <div
              className={`w-full mx-auto fixed top-0 left-0 right-0 flex justify-between items-center text-center p-4 md:p-6 backdrop-blur-md bg-opacity-70 ${colorMode ? "bg-black" : "bg-white"} z-50`}
            >
