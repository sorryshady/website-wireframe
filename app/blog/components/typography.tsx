...
export const typographyVariants = cva("", {
  variants: {
    as: {
      ...
      th: "border px-4 py-2 text-left font-bold text-gray-900 [&[align=center]]:text-center [&[align=right]]:text-right",
      tbody: "",
      td: "border px-4 py-2 text-left text-gray-700 [&[align=center]]:text-center [&[align=right]]:text-right",
