  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h2 className="services-title text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-white">
          Services
        </h2>
        <p className="services-description text-base sm:text-lg text-gray-400">
